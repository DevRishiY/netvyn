...
export const Hero = () => {
  return (
    ...
    <div className="container relative">
      ...
      <h1 className='text-7xl sm:text-9xl font-bold tracking-tightner text-center inline-flex'>Netvyn <br/> is more</h1>
      ...
      <p className='text-xl text-center mt-8 max-w-md'>Reliability, Speed, Locations all in one host. Launch Instant, performance filled game servers, optimized by the developers of netvyn, waiting to be yours!</p>
      </div>
      <div className="flex justify-center mt-8">

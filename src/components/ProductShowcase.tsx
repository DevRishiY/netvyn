  ...
  return (
    <div className="bg-black text-white bg-gradient-to-b from-black to-[#5D2CA8] py-[72px] sm:py-24">
      <div className="container">
        ...
        <p className="text-xl text-white/70 text-center mt-5 ">Intrsting U.I made for you There are many variations available, but the majority have used this. Reliability, Speed, Locations all in one host.</p>
        </div>
